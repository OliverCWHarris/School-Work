...
#-----------------------------------------------------------------------------------------------------#
                    HiScoreChoice=str(input('Save current score? y/n \n>'))
                    HiScoreChoice=HiScoreChoice.lower()
                    try:
                        if HiScoreChoice=='y':
                            Username=str(input('Enter username \n>'))
                            with open('HiScoreTable.txt','a') as f:
                                f.write(str(self.__Score) + '' + Username)
                        elif HiScoreChoice=='n':
                            pass
                        else:
                            print('error line 112-123')
                    except ValueError:
